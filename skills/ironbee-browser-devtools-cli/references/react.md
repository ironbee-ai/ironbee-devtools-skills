...
```bash
ironbee-browser-devtools-cli react get-component-for-element --selector <selector>
```
...
ironbee-browser-devtools-cli react get-component-for-element --selector "button.submit"

# Find component for a specific element (JSON for parsing)
ironbee-browser-devtools-cli --json react get-component-for-element --selector "[data-testid='user-card']"

# Find component for form
ironbee-browser-devtools-cli --json react get-component-for-element --selector "form#login"
```
...
```bash
ironbee-browser-devtools-cli react get-element-for-component --component-name <name>
```
...
ironbee-browser-devtools-cli react get-element-for-component --component-name "Button"

# Find elements by component name (JSON for parsing)
ironbee-browser-devtools-cli --json react get-element-for-component --component-name "UserCard"

# Find specific component instance
ironbee-browser-devtools-cli --json react get-element-for-component --component-name "Header"
```
...
ironbee-browser-devtools-cli --no-headless --persistent navigation go-to --url "chrome://extensions"
```
...
ironbee-browser-devtools-cli $SESSION react get-component-for-element --selector "[data-testid='user-profile']"

# Find where a component renders
ironbee-browser-devtools-cli $SESSION react get-element-for-component --component-name "ErrorBoundary"

# Screenshot component
ironbee-browser-devtools-cli $SESSION content take-screenshot --selector "[data-testid='user-profile']" --name "user-profile"
```
...
COMPONENT=$(ironbee-browser-devtools-cli $SESSION react get-component-for-element --selector ".dashboard")
...
BUTTONS=$(ironbee-browser-devtools-cli $SESSION react get-element-for-component --component-name "Button")
...
ironbee-browser-devtools-cli $SESSION react get-component-for-element --selector "nav"

# Check accessibility of the same element
ironbee-browser-devtools-cli $SESSION a11y take-aria-snapshot --selector "nav"
```
