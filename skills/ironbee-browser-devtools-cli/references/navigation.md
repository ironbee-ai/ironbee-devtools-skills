...
```bash
ironbee-browser-devtools-cli navigation go-to --url <url> [options]
```
...
# With timeout
ironbee-browser-devtools-cli navigation go-to --url "https://example.com" --timeout 10000

# Wait for DOM ready
ironbee-browser-devtools-cli navigation go-to --url "https://example.com" --wait-until domcontentloaded

# JSON output for parsing
ironbee-browser-devtools-cli --json navigation go-to --url "https://example.com"
```
...
```bash
ironbee-browser-devtools-cli navigation go-back-or-forward --direction <back|forward> [options]
```
...
ironbee-browser-devtools-cli navigation go-back-or-forward --direction back --wait-until domcontentloaded
```
...
```bash
ironbee-browser-devtools-cli navigation reload [options]
```
...
ironbee-browser-devtools-cli navigation reload --wait-until networkidle
```
...
ironbee-browser-devtools-cli $SESSION interaction click --selector "a.next-page"

# Go back
ironbee-browser-devtools-cli $SESSION navigation go-back-or-forward --direction back

# Go forward
ironbee-browser-devtools-cli $SESSION navigation go-back-or-forward --direction forward

# Reload
ironbee-browser-devtools-cli $SESSION navigation reload
```
